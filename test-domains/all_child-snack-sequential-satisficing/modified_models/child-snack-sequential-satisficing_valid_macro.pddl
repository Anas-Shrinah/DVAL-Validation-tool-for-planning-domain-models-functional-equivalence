;Child-snack with random valid macro ## Add valid macro ## No ## The valid macro operator ``make_sandwich_no_gluten-put_on_tray-serve_sandwich_no_gluten'' is added to this domain.
...
(define (domain child-snack)
  ...
  (:action make_sandwich_no_gluten-put_on_tray-serve_sandwich_no_gluten_M
    ...
    :precondition (and (at_kitchen_bread_M ?x2 ) (at_kitchen_content_M ?x1 ) (no_gluten_bread_M ?x2 ) (no_gluten_content_M ?x1 ) (notexist_M ?x3 ) (at_kitchen_tray_M ?x4 ) (allergic_gluten_M ?x7 ) (waiting_M ?x7 ?x5 ) (at_M ?x4 ?x5 ) )
    :effect (and (no_gluten_sandwich_M ?x3 ) (served_M ?x7 ) (not (at_kitchen_bread_M ?x2 )) (not (at_kitchen_content_M ?x1 )) (not (notexist_M ?x3 )) (not (at_kitchen_sandwich_M ?x3 )) (not (ontray_M ?x3 ?x4 )) 
 )
  )
)
