;Child-snack with crafted valid macro ## Add crafted valid macro ## No ## The valid macro operator ``make_sandwich_put_on_tray'' is added to this domain.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
...
(:predicates (at_kitchen_bread ?b - bread-portion)
	     (at_kitchen_content ?c - content-portion)
     	     ...
     	     ; at_kitchen_tray is added to remove the constant kitchen
     	     (at_kitchen_tray ?t - tray)
...
(:action make_sandwich_put_on_tray
	 :parameters (?s - sandwich ?b - bread-portion ?c - content-portion ?t - tray)
	 :precondition (and (at_kitchen_bread ?b)
			    (at_kitchen_content ?c)
                            (notexist ?s)
                            (at_kitchen_tray ?t)
