;Parking with random valid macro ## Add valid macro ## No ## The valid macro operator ``move-curb-to-curb-move-curb-to-car-move-car-to-curb'' is added to this domain.
...
(define (domain parking)
  ...
  (:action move-curb-to-curb-move-curb-to-car-move-car-to-curb_M
    ...
    :precondition (and (car-clear_M ?x1 ) (curb-clear_M ?x5 ) (at-curb-num_M ?x1 ?x4 ) (car-clear_M ?x2 ) (at-curb_M ?x2 ) )
    :effect (and (at-curb_M ?x1 ) (not (at-curb-num_M ?x1 ?x5 )) (not (curb-clear_M ?x4 )) (not (behind-car_M ?x1 ?x2 )) 
 )
  )
)
