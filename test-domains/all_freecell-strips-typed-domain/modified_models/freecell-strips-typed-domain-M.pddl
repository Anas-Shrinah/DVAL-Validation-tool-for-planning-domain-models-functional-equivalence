;Freecell with crafted valid macro ## Add crafted valid macro ## No ## The valid macro operator ``move-sendtohome'' is added to this domain.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; FreeCellWorld
...
(:action move-sendtohome
	   :parameters (?card ?oldcard ?newcard ?oldoldcard - card ?suit - suit ?vcard - num
			    ?homecard - card ?vhomecard - num)
	   :precondition (and (clear ?card) 
			      (clear ?newcard)
			      (canstack ?card ?newcard)
			      (on ?card ?oldcard)
			      (on ?oldcard ?oldoldcard)
