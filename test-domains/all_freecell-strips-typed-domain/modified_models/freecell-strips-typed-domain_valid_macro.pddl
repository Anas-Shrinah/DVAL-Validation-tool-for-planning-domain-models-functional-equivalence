;Freecell with random valid macro ## Add valid macro ## No ## The valid macro operator ``move-move-b-sendtofree'' is added to this domain.
...
(define (domain freecell)
  ...
  (:action move-move-b-sendtofree_M
    ...
    :precondition (and (clear_M ?x3 ) (clear_M ?x2 ) (canstack_M ?x3 ?x2 ) (on_M ?x3 ?x1 ) (bottomcol_M ?x1 ) (canstack_M ?x1 ?x3 ) (colspace_M ?x4 ) (successor_M ?x5 ?x4 ) (on_M ?x1 ?x2 ) (cellspace_M ?x4 ) (successor_M ?x4 ?x5 ) )
    :effect (and (on_M ?x3 ?x2 ) (on_M ?x1 ?x3 ) (colspace_M ?x5 ) (incell_M ?x1 ) (cellspace_M ?x5 ) (not (on_M ?x3 ?x1 )) (not (bottomcol_M ?x1 )) (not (clear_M ?x3 )) (not (colspace_M ?x4 )) (not (on_M ?x1 ?x2 )) (not (clear_M ?x1 )) (not (cellspace_M ?x4 )) 
 )
  )
)
