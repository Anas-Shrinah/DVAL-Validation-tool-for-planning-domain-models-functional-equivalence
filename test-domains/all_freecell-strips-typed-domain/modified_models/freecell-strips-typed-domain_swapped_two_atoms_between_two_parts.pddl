;Freecell with swapped atoms ## Swap between add effect and precondition ## Yes ## The atom (cellspace ?ncells) in the add effects of the operator ``colfromfreecell'' in the original domain is swapped with the atom (successor ?ncells ?cells) from the preconditions from the same operator in the original domain.
