;Rover with deleted operator ## Delete operator ## Yes ## The operator ``communicate_rock_data'' is removed from this modified domain, this operator exists in the original domain.
