;Rover with random valid macro ## Add valid macro ## No ## The valid macro operator ``navigate-sample_soil-drop'' is added to this domain.
...
(define (domain rover)
  ...
  (:action navigate-sample_soil-drop_M
    ...
    :precondition (and (can_traverse_M ?x1 ?x2 ?x3 ) (available_M ?x1 ) (at_M ?x1 ?x2 ) (visible_M ?x2 ?x3 ) (at_soil_sample_M ?x3 ) (equipped_for_soil_analysis_M ?x1 ) (store_of_M ?x5 ?x1 ) (empty_M ?x5 ) )
    :effect (and (at_M ?x1 ?x3 ) (have_soil_analysis_M ?x1 ?x3 ) (not (at_M ?x1 ?x2 )) (not (at_soil_sample_M ?x3 )) (not (full_M ?x5 )) 
 )
  )
)
