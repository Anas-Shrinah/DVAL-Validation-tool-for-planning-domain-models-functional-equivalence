;Scanalyzer with random valid macro ## Add valid macro ## No ## The valid macro operator ``analyze-2-analyze-4-rotate-2'' is added to this domain.
...
(define (domain scanalyzer3d)
  ...
  (:action analyze-2-analyze-4-rotate-2_M
    ...
    :precondition (and (cycle-2-with-analysis_M ?x1 ?x2 ) (on_M ?x5 ?x1 ) (on_M ?x6 ?x2 ) (cycle-4-with-analysis_M ?x4 ?x3 ?x2 ?x1 ) (on_M ?x8 ?x4 ) (on_M ?x7 ?x3 ) (cycle-2_M ?x3 ?x2 ) )
    :effect (and (analyzed_M ?x5 ) (on_M ?x8 ?x1 ) (on_M ?x7 ?x4 ) (analyzed_M ?x8 ) (on_M ?x5 ?x2 ) (on_M ?x6 ?x3 ) (not (on_M ?x5 ?x1 )) (not (on_M ?x8 ?x4 )) (not (on_M ?x7 ?x3 )) (not (on_M ?x6 ?x1 )) (not (on_M ?x5 ?x3 )) (not (on_M ?x6 ?x2 )) 
 )
  )
)
