;Scanalyzer with crafted valid macro ## Add crafted valid macro ## No ## The valid macro operator ``analyze-2-rotate-2'' is added to this domain.
(define (domain scanalyzer3d)
  ...
  (:action analyze-2-rotate-2
   :parameters (?s1 ?s2 - segment ?c1 ?c2 - car)
   :precondition (and (CYCLE-2-WITH-ANALYSIS ?s1 ?s2) (CYCLE-2 ?s2 ?s1)
		      (on ?c1 ?s1)
		      (on ?c2 ?s2)
		  )
   :effect (and 
