;Pipesworld with random valid macro ## Add valid macro ## No ## The valid macro operator ``push-start-push-end-pop-start'' is added to this domain.
...
(define (domain pipesworld)
  ...
  (:action push-start-push-end-pop-start_M
    ...
    :precondition (and (normal_M ?x1 ) (first_M ?x3 ?x1 ) (connect_M ?x4 ?x5 ?x1 ) (on_M ?x2 ?x4 ) (not-unitary_M ?x1 ) (is-product_M ?x2 ?x6 ) (is-product_M ?x3 ?x7 ) (may-interface_M ?x6 ?x7 ) (last_M ?x2 ?x1 ) (follow_M ?x2 ?x3 ) )
    :effect (and (first_M ?x2 ?x1 ) (follow_M ?x3 ?x2 ) (pop-updating_M ?x1 ) (not (first_M ?x3 ?x1 )) (not (on_M ?x2 ?x4 )) (not (push-updating_M ?x1 )) (not (normal_M ?x1 )) (not (last_M ?x3 ?x1 )) (not (on_M ?x2 ?x5 )) 
 )
  )
)
