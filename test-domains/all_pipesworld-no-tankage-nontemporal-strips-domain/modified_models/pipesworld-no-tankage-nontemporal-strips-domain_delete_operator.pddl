;Pipesworld with deleted operator ## Delete operator ## Yes ## The operator ``push-unitarypipe'' is removed from this modified domain, this operator exists in the original domain.
