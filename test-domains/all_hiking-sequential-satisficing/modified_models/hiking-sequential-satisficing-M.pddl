;Hiking with crafted valid macro ## Add crafted valid macro ## No ## The valid macro operator ``drive_tent_put_up'' is added to this domain.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(at_person ?x1 ?x2)(at_tent ?x3 ?x2)(down ?x3))
  ...
  (:action drive_passenger
         ...
         :precondition (and 
(at_person ?x1 ?x2)(at_car ?x4 ?x2)(at_person ?x5 ?x2)
; (not (= ?x1 ?x5))
)
...
(at_tent ?x5 ?x3)(not (at_tent ?x5 ?x2))
  ...
  (:action drive_tent_put_up
         :parameters ( ?x1 - person ?x2 - place ?x3 - place ?x4 - car ?x5 - tent)
         :precondition (and 
                        (at_person ?x1 ?x2)
                          (at_car ?x4 ?x2)(at_tent ?x5 ?x2)(down ?x5))
