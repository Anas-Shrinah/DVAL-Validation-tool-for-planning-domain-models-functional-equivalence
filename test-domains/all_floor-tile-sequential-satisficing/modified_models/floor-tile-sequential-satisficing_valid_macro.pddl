;Floor-tile with random valid macro ## Add valid macro ## No ## The valid macro operator ``change-color-paint-up-paint-down'' is added to this domain.
...
(define (domain floor-tile)
  ...
  (:action change-color-paint-up-paint-down_M
    ...
    :precondition (and (robot-has_M ?x1 ?x2 ) (available-color_M ?x3 ) (robot-at_M ?x1 ?x5 ) (up_M ?x4 ?x5 ) (clear_M ?x4 ) (robot-at_M ?x1 ?x4 ) (down_M ?x5 ?x4 ) (clear_M ?x5 ) )
    :effect (and (robot-has_M ?x1 ?x3 ) (painted_M ?x4 ?x3 ) (painted_M ?x5 ?x3 ) (not (robot-has_M ?x1 ?x2 )) (not (clear_M ?x4 )) (not (clear_M ?x5 )) 
 )
  )
)
